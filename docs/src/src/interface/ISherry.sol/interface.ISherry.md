# ISherry
[Git Source](https://github.com/SherryLabs/sherry-contracts/blob/7a518fc7af89cc17cb6934c571dd7777aca3d0a8/src/interface/ISherry.sol)
...
|`kol`|`address`|The address of the KOL who created the post.|
|`idCampaign`|`uint256`|The ID of the campaign associated with the post.|
|`url`|`string`|The URL of the newly created post.|
