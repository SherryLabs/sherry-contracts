...
/**
 * @title KOLRouterSomniaV2
 * @notice Router for KOLs that supports direct swaps via Somnia v2 using ISomniaRouter.
 * @dev Handles both native and ERC20 swaps, applying a fixed fee in native token (e.g., AVAX).
 */
contract KOLRouterSomniaV2 is KOLSwapRouterBase {
     ...
     * @param _dexRouter Address of the Somnia UniversalRouter
    ...
    function swapExactTokensForTokens(
        ...
        amounts = ISomniaRouter(dexRouter).swapExactTokensForTokens(
    ...
    function swapTokensForExactTokens(
        ...
        amounts = ISomniaRouter(dexRouter).swapTokensForExactTokens(
            amountOut,
            netAmountData.netAmount,
            path,
            to,
     ...
     * @dev Deducts fee and forwards the remaining native value to Somnia router.
    ...
    function swapExactAVAXForTokens(
        ...
        amounts = ISomniaRouter(dexRouter).swapExactAVAXForTokens{
    ...
    function swapTokensForExactAVAX(
        ...
        amounts = ISomniaRouter(dexRouter).swapTokensForExactAVAX(
            amountOut,
            netAmountData.netAmount,
            path,
            to,
    ...
    function swapExactTokensForAVAX(
        ...
        amounts = ISomniaRouter(dexRouter).swapExactTokensForAVAX(
            netAmountData.netAmount,
            amountOutMin,
            path,
            to,
    ...
    function swapAVAXForExactTokens(
        ...
        amounts = ISomniaRouter(dexRouter).swapAVAXForExactTokens{
            value: netAmountData.netAmount
